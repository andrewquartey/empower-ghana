                                ...
                                <div className="blog-details">
                                    ...
                                    <div className="blog-meta">
                                        <ul>
                                            ...
                                            <li>
                                                <i className="far fa-clock"></i> June 20, 2019
                                            </li>
                                            <li>
                                    ...
                                    <p>
                                        ...
                                        anything of embarrassing. There are many that an variations
                                        of passages of Lorem Ipsum available but the majority have
                                        suffered alteration in that some form by a injected humour
                                        or randomised words which don’t look even of slightly
                                        believable. If you are going to use a the passage of Lorem
                                    ...
                                    <p>
                                        ...
                                        If you are going a to use a passage you need to be sure
                                            ...
                                            <article className="comment-body">
                                                <footer className="comment-meta">
                                                    <div className="comment-author vcard">
                                                        <img
                                                            src={require('../images/author1.jpg')}
                                                            alt="image"
                                                            className="avatar"
                                                        />
                                                    ...
                                                    <div className="comment-metadata">
                                                        <a href="#">March 28, 2019 at 7:16 am</a>
                                                    </div>
                                                </footer>
                                                ...
                                                <div className="comment-content">
                                                    <p>
                                                        ...
                                                        ante. It is a long established fact that a
                                                ...
                                                <li className="comment">
                                                    <article className="comment-body">
                                                        <footer className="comment-meta">
                                                            <div className="comment-author vcard">
                                                                <img
                                                                    src={require('../images/author2.jpg')}
                                                                    alt="image"
                                                                    className="avatar"
                                                                />
                                                        ...
                                                        <div className="comment-content">
                                                            <p>
                                                                ...
                                                                posuere erat a ante. It is a long
                                        ...
                                        <li className="comment">
                                            <article className="comment-body">
                                                <footer className="comment-meta">
                                                    <div className="comment-author vcard">
                                                        <img
                                                            src={require('../images/author3.jpg')}
                                                            alt="image"
                                                            className="avatar"
                                                        />
                                                        <b className="fn">John Smith</b>
