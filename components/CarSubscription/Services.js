                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="services-box">
                                <img
                                    src={require('../../images/car-services1.jpg')}
                                    alt="services"
                                />
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="services-box">
                                <img
                                    src={require('../../images/car-services2.jpg')}
                                    alt="services"
                                />
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="services-box">
                                <img
                                    src={require('../../images/car-services3.jpg')}
                                    alt="services"
                                />
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="services-box">
                                <img
                                    src={require('../../images/car-services4.jpg')}
                                    alt="services"
                                />
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="services-box">
                                <img
                                    src={require('../../images/car-services5.jpg')}
                                    alt="services"
                                />
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="services-box">
                                <img
                                    src={require('../../images/car-services6.jpg')}
                                    alt="services"
                                />
