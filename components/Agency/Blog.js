                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog-post">
                                <div className="image">
                                    <img
                                        src={require('../../images/agency-blog1.jpg')}
                                        alt="image"
                                    />
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog-post">
                                <div className="image">
                                    <img
                                        src={require('../../images/agency-blog2.jpg')}
                                        alt="image"
                                    />
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                            <div className="single-blog-post">
                                <div className="image">
                                    <img
                                        src={require('../../images/agency-blog3.jpg')}
                                        alt="image"
                                    />
                                </div>
                                ...
                                <div className="blog-post-content">
                                    <h3>
                                        <a href="#">12 Tried-and-True Ways to Improve User</a>
                                    </h3>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                        do eiusmod tempor incididunt ut labore et dolore magna
